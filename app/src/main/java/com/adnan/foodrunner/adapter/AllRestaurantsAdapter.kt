...
import com.adnan.foodrunner.database.RestaurantDatabase
import com.adnan.foodrunner.database.RestaurantEntity
...
class AllRestaurantsAdapter(private var restaurants: ArrayList<Restaurants>, val context: Context) :
    ...
    override fun onBindViewHolder(p0: AllRestaurantsViewHolder, p1: Int) {
        ...
        p0.cardRestaurant.setOnClickListener {
            ...
            intent.putExtra("resName",resObject.name)
            //Toast.makeText(context,"${resObject.id}",Toast.LENGTH_LONG).show()
